  ...
  return (
    <li className="flex gap-3 rounded-md border border-danger bg-danger-fill p-[12px_14px]">
      ...
      <div className="min-w-0">
        <div className="text-sm font-semibold leading-[1.35] text-danger-fg">
          {label}
        </div>
        <div className="mt-[3px] text-[13px] leading-[1.45] text-fg-2">
          {detail}
        </div>
      </div>
    </li>
...
export default function DeleteAccountFlow({
  ...
  if (step === "checking") {
    return (
      ...
      >
        <Loader
          size={46}
          className="spin mx-auto mb-[18px] block text-green-800"
        />
        ...
        <div className="mt-1.5 text-[13.5px] text-fg-2">
          Estamos comprobando si tu cuenta puede darse de baja.
        </div>
      </Modal>
    );
  }
  ...
  if (step === "warn") {
    return (
      <Modal onClose={onClose}>
        <IconCircle tone="danger" className="mb-[18px]">
          <Trash2 size={26} className="text-danger-fg" />
        </IconCircle>
        ...
        <Alert tone="warning" className="mb-[18px]">
          ...
          a tu historial, reservas y mensajes.
        </Alert>
        <div className="mb-[18px] flex items-center gap-[9px] rounded-md border border-green-300 bg-green-050 p-[10px_13px]">
          ...
          <div className="text-[13px] font-semibold text-green-800">
            Cumplís las condiciones para dar de baja tu cuenta.
          </div>
        </div>
        <div className={modalActions}>
          ...
          <Button variant="danger" onClick={confirmar}>
            <Trash2 size={16} /> Confirmo eliminar mi cuenta
          </Button>
        </div>
      </Modal>
    );
  ...
  if (step === "success") {
    return (
      <Modal dismissable={false} className="text-center">
        <IconCircle tone="success" className="mx-auto mb-[18px]">
          <Check size={28} className="text-success-fg" />
        </IconCircle>
        <h3 className={`mb-2 text-center ${modalTitle}`}>
        ...
        <div className="flex justify-center">
          <Button onClick={() => cerrarSesion("/explorar")}>
  ...
  return (
    <Modal onClose={onClose} className="text-center">
      <IconCircle tone="danger" className="mx-auto mb-[18px]">
        <AlertOctagon size={26} className="text-danger-fg" />
      </IconCircle>
      <h3 className={`mb-2 text-center ${modalTitle}`}>
        No se pudo completar la operación
      </h3>
      <p className={`mb-5 text-center ${modalLead}`}>
        Ocurrió un error y tu cuenta sigue activa. Volvé a intentarlo en unos
        minutos.
      </p>
      <div className="flex justify-center gap-3">
        ...
        <Button variant="danger" onClick={reintentarCheck}>
