...
export const PermisoAdmin = {
  ...
  LEER_ESTABLECIMIENTO: "LEER_ESTABLECIMIENTO",
  GESTIONAR_ESTABLECIMIENTO: "GESTIONAR_ESTABLECIMIENTO",
...
export const PermisoProductor = {
  ...
  GESTIONAR_ACTIVIDAD: "GESTIONAR_ACTIVIDAD",
} as const;
