...
const NAV: { section?: string; id?: string; iconC?: React.ComponentType<{ size?: number; color?: string }>; label?: string; href?: string; badge?: number }[] = [
  ...
  { section: "Acceso" },
  { id: "admins", iconC: UserCog, label: "Administradores" },
  { id: "roles", iconC: ShieldCheck, label: "Roles de administrador" },
  { section: "Plataforma" },
  { id: "solicitudes", iconC: ClipboardCheck, label: "Solicitudes de establecimientos", badge: 3 },
  { id: "establecimientos", iconC: Warehouse, label: "Establecimientos" },
  { section: "Contenido" },
  ...
  { id: "impagas", iconC: HandCoins, label: "Reservas impagas" },
  { id: "deudas", iconC: Landmark, label: "Deudas de productores" },
  { section: "Soporte" },
